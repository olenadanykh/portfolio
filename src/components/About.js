...
<p>I enjoy building things, exploring and learning something new - as my recent project <a target="https://github.com/oslabs-beta/Trinity" href="https://github.com/oslabs-beta/Trinity">Trinity</a> - a developer tool for previewing Neo4j queries and database structure within the VS Code environment. I am especially an engineer focused on building full-stack applications with React/Redux, Node/Express, PostgreSQL/MongoDB.</p>
...
<h2 className="p">I'd love to hear from you, so please feel free to reach out!</h2>
